 ...
 */
define('UPDATE_URL', 'https://www.resolveworkcrm.com/resolvework_updates/index.php');

/**
 * Get latest version info
 */
define('UPDATE_INFO_URL', 'https://www.resolveworkcrm.com/resolvework_updates/update_info.php');
