 ...
 */
define('UPDATE_URL', 'https://www.exampleperfexcrm.com/perfex_updates/index.php');

/**
 * Get latest version info
 */
define('UPDATE_INFO_URL', 'https://www.exampleperfexcrm.com/perfex_updates/update_info.php');
