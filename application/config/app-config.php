...
*
*/
define('APP_BASE_URL', 'https://crm.saurashtratech.com/');
...
*/
define('APP_ENC_KEY', 'dd49d7e1dcb41d01174ebb7f19ebd536');
 ...
 */
// define('APP_DB_USERNAME', 'perfex_st');
define('APP_DB_USERNAME', 'saurashtratech_crm');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '#TU^8*8zuSfioA');
/**
 * The name of the database you want to connect to
 */
// define('APP_DB_NAME', 'perfexdb_st');
define('APP_DB_NAME', 'saurashtratech_crmdb');
