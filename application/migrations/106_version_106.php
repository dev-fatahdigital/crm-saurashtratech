...
/*        if(!is_dir(BACKUPS_FOLDER)){
        ...
        if($theme != 'resolvework'){
            copy(APPPATH . 'views/themes/resolvework/template_parts/contract_attachments.php',APPPATH . 'views/themes/' . active_clients_theme() . '/template_parts/contract_attachments.php');
        }
