...
class Migration_Version_230 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        if (file_exists(VIEWPATH . 'themes/resolvework/scripts.php')) {
            @unlink(VIEWPATH . 'themes/resolvework/scripts.php');
        }
        ...
        foreach ($themes as $theme) {
            if ($theme != 'resolvework') {
                if (!file_exists(VIEWPATH . 'themes/' . $theme . '/functions.php')) {
                    copy(VIEWPATH . 'themes/resolvework/functions.php', VIEWPATH . 'themes/' . $theme . '/functions.php');
                }
            }
        }
